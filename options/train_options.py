...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_age_bias', type=float, default=1.0,
                                 help='weight for age encoding consistency loss')
        self.parser.add_argument('--lambda_latent', type=float, default=100.0,help='weight for age encoding consistency loss')
        self.isTrain = True
